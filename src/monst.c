 ...
 */
	...
	M1_FLY|M1_BREATHLESS|M1_NOLIMBS|M1_NOHEAD|M1_MINDLESS,
	M2_HOSTILE|M2_NASTY|M2_NEUTER, M3_INFRAVISIBLE|M3_NOPOLY, CLR_BROWN),
/*
 * felines
 */
    MON("kitten", S_FELINE,
 ...
 */
    ...
    MON("nightmare", S_UNICORN,
        LVL(10, 26, 4, 0, -6), (G_HELL|G_GENO|G_SGROUP|2),
        A(ATTK(AT_KICK, AD_FIRE, 4, 4), ATTK(AT_KICK, AD_FIRE, 4, 4),
          ATTK(AT_BITE, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1800, 350, 0, MS_NEIGH, MZ_LARGE), MR_FIRE|MR_POISON, 0,
        M1_ANIMAL|M1_NOHANDS|M1_FLY,
        M2_WANDER|M2_STRONG|M2_DEMON|M2_HOSTILE,
        M3_INFRAVISIBLE, CLR_RED),
/*
 * vortices
 */
	...
	A(ATTK(AT_ENGL, AD_ELEC, 1, 6), ATTK(AT_ENGL, AD_DREN, 1, 6),
 ...
 */
	...
	A(ATTK(AT_ENGL, AD_PHYS, 1, 10),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(0, 0, sizeof(struct epri), MS_SILENT, MZ_HUGE),
	...
	A(ATTK(AT_CLAW, AD_PHYS, 4, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(2500, 0, sizeof(struct epri), MS_SILENT, MZ_HUGE),
 ...
 */
	...
	CLR_BROWN),
    MON("elder minotaur", S_GIANT,
        LVL(26, 13, -8, 25, -4), (G_HELL|G_GENO|1),
        A(ATTK(AT_CLAW, AD_PHYS, 6, 7), ATTK(AT_CLAW, AD_PHYS, 6, 7),
          ATTK(AT_BUTT, AD_PHYS, 8, 5), ATTK(AT_HUGS, AD_PHYS, 8, 3), NO_ATTK, NO_ATTK),
        SIZ(2200, 900, 0, MS_ROAR, MZ_HUGE), 0, 0,
 ...
 */
    ...
    MON("dragon zombie", S_ZOMBIE,
        LVL(14, 9, -1, 20, -4), (G_GENO|1),
        A(ATTK(AT_CLAW, AD_PHYS, 4, 4), ATTK(AT_CLAW, AD_PHYS, 4, 4),
          ATTK(AT_BITE, AD_DRIN, 4, 6), ATTK(AT_BREA, AD_DRST, 4, 6), NO_ATTK, NO_ATTK),
        SIZ(WT_DRAGON, 1500, 0, MS_SILENT, MZ_GIGANTIC),
        MR_COLD|MR_SLEEP|MR_POISON|MR_FIRE, 0,
        M1_FLY|M1_THICK_HIDE|M1_NOHANDS|M1_SEE_INVIS|M1_BREATHLESS|M1_MINDLESS,
        M2_UNDEAD|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_STALK|M2_GREEDY|M2_JEWELS|M2_MAGIC,
...
#undef SEDUCTION_ATTACKS
	...
	A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	  ...
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, sizeof(struct epri), MS_SPELL, MZ_LARGE),
	MR_FIRE|MR_POISON, 0,
	M1_HUMANOID|M1_POIS, M2_DEMON|M2_STALK|M2_HOSTILE|M2_NASTY,
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_RED),
	...
	A(ATTK(AT_WEAP, AD_PHYS, 4, 2), ATTK(AT_WEAP, AD_PHYS, 4, 2),
	  ATTK(AT_HUGS, AD_PHYS, 2, 4), NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, sizeof(struct epri), MS_GROWL, MZ_LARGE),
	MR_FIRE|MR_POISON, 0,
