 ...
 */
    ...
    MON("nightmare", S_UNICORN,
        LVL(10, 24, 4, 0, -3), (G_HELL|G_GENO|2),
 ...
 */
    ...
    MON("elder minotaur", S_GIANT,
        LVL(19, 12, -2, 25, -4), (G_GENO|G_HELL|1),
        A(ATTK(AT_CLAW, AD_PHYS, 6, 6), ATTK(AT_CLAW, AD_PHYS, 6, 6),
          ATTK(AT_BUTT, AD_PHYS, 6, 5), ATTK(AT_HUGS, AD_PHYS, 8, 2), NO_ATTK, NO_ATTK),
 ...
 */
    ...
    MON("zombie dragon", S_ZOMBIE,
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
          ATTK(AT_BITE, AD_DRIN, 3, 8), NO_ATTK, NO_ATTK, NO_ATTK),
        ...
        M2_UNDEAD|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_STALK|M2_MAGIC,
