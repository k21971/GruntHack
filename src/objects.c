...
#define SCROLL(name,text,mgc,prob,cost) OBJECT( \
	...
	SCROLL("enchant armor",         "ZELGO MER",            1,  60,  80),
	SCROLL("destroy armor",         "JUYED AWK YACC",       1,  43, 100),
	SCROLL("confuse monster",       "NR 9",                 1,  51, 100),
	SCROLL("scare monster",         "XIXAXA XOXAXA XUXAXA", 1,  33, 100),
	SCROLL("remove curse",          "PRATYAVAYAH",          1,  62,  80),
	SCROLL("enchant weapon",        "DAIYEN FOOELS",        1,  77,  60),
	SCROLL("create monster",        "LEP GEX VEN ZEA",      1,  43, 200),
	SCROLL("taming",                "PRIRUTSENIE",          1,  14, 200),
	SCROLL("genocide",              "ELBIB YLOH",           1,  14, 300),
	SCROLL("light",                 "VERR YED HORRE",       1,  87,  50),
	SCROLL("teleportation",         "VENZAR BORGAVVE",      1,  53, 100),
	SCROLL("gold detection",        "THARR",                1,  32, 100),
	SCROLL("food detection",        "YUM YUM",              1,  24, 100),
	SCROLL("identify",              "KERNOD WEL",           1, 173,  20),
	SCROLL("magic mapping",         "ELAM EBOW",            1,  43, 100),
	SCROLL("amnesia",               "DUAM XNAHT",           1,  33, 200),
	SCROLL("fire",                  "ANDOVA BEGARIN",       1,  29, 100),
	SCROLL("earth",                 "KIRJE",                1,  17, 200),
	SCROLL("punishment",            "VE FORBRYDERNE",       1,  14, 300),
	SCROLL("charging",              "HACKEM MUCHE",         1,  14, 300),
	SCROLL("stinking cloud",	"VELOX NEB",            1,  14, 300),
	SCROLL("detect magic",		"FOOBIE BLETCH",        1,  43, 100),
...
#endif
	SCROLL("blank paper",           "unlabeled",        0,  27,  10),
#undef SCROLL
