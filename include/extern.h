...
E struct monst *NDECL(make_mon_traits_for_bones);
...
E boolean FDECL(findtravelpath, (struct monst *,xchar,xchar,schar*,schar*,long*,BOOLEAN_P));
E void NDECL(domove);
...
E struct obj *FDECL(getobj, (const char *,const char *,BOOLEAN_P));
...
E int FDECL(waterbody_prefix, (XCHAR_P,XCHAR_P));
...
E boolean FDECL(mcheckpos, (struct monst *,xchar,xchar,xchar,xchar,long*,long,BOOLEAN_P));
...
E char *FDECL(Shk_Your, (char *,struct obj *));
E void FDECL(adjust_bill_val, (struct obj *));
E void FDECL(costly_damage_obj, (struct obj *));
...
E boolean FDECL(water_damage, (struct monst *,struct obj *,BOOLEAN_P,BOOLEAN_P));
